...
**Based on the above table, the total number of flights across all airlines equals 3,084,159.**
...
aircraft_events_sum_stats_all <- aircraft_events_sum_stats %>%
  group_by(airline_name) %>%
  summarize(`Number of Incidents` = sum(num_aircraft_in_incident)) %>%
  rename(`Airline Name` = airline_name)
...
Based on the table above, ***among the airlines involved in this study, there are only 2 events out of the 3,084,159 flights that resulted in fatalities between January 2008 - August 2024, which corresponds to a 0.000065 % rate that these U.S. airlines collectively experience a fatal incident.***
...
1.  The airline with the highest ratio (0.002 %) of their aircraft involved in NTSB investigated events relative to the number of flights flown is American Airlines.
